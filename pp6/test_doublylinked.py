...
class TestDoublyLinkedList(unittest.TestCase):
    ...
    def test_remove(self):
        ...
        self.check(
            a,
            lambda x: x.remove_first(99),
            4,
            "[27, 13, 13, 27, 99, 99, 99, 27, 1, 29, 13, 17, 27, 88]",
        )
        self.check(
            a,
            lambda x: x.remove_first(88),
            4,
            "[27, 13, 13, 27, 99, 99, 99, 27, 1, 29, 13, 17, 27]",
        )
        self.check(
            a,
            lambda x: x.remove_last(99),
            4,
            "[27, 13, 13, 27, 99, 99, 27, 1, 29, 13, 17, 27]",
        )
        self.check(
            a,
            lambda x: x.remove_last(37),
            4,
            "[27, 13, 13, 27, 99, 99, 27, 1, 29, 13, 17, 27]",
        )
        self.check(
            a,
            lambda x: x.remove_first(42),
            4,
            "[27, 13, 13, 27, 99, 99, 27, 1, 29, 13, 17, 27]",
        )
        self.check(
            a,
            lambda x: x.remove_first(1),
            4,
            "[27, 13, 13, 27, 99, 99, 27, 29, 13, 17, 27]",
        )
        self.check(a, lambda x: x.remove_all(13), 4, "[27, 27, 99, 99, 27, 29, 17, 27]")
        self.check(a, lambda x: x.remove_all(27), 4, "[99, 99, 29, 17]")
    ...
    def test_takeout(self):
        ...
        self.checkTakeOut(a, 0, 8, 5, "[]", "[99, 27, 13, 13, 29, 13, 17, 27, 88]")
        a = make(99, 12, 13, 44, 55)
        self.checkTakeOut(a, 2, 2, 4, "[99, 12, 44, 55]", "[13]")
        self.checkTakeOut(a, 1, 3, 5, "[99]", "[12, 44, 55]")
        a = makeFrom(range(1000))
        self.checkTakeOut(a, 0, 10, 5, str(list(range(11, 1000))), str(list(range(11))))
        self.checkTakeOut(
            a,
            100,
            500,
            10,
            str(list(range(11, 111)) + list(range(512, 1000))),
    ...
    def test_constant_time(self):
        ...
        self.assertLess(
            t1 - t0,
            0.001,
            msg="Your takeout function doesn't seem to work in constant time",
        )
