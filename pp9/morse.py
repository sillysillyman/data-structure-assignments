...
morse_table = Morse(
    ...
    Morse(
        "E",
        Morse("I", Morse("S", Morse("H"), Morse("V")), Morse("U", Morse("F"))),
        Morse(
            "A",
            Morse("R", Morse("L")),
            Morse("W", Morse("P"), Morse("J", None, Morse("1"))),
        ),
    ),
    Morse(
        "T",
        Morse(
            "N", Morse("D", Morse("B"), Morse("X")), Morse("K", Morse("C"), Morse("Y"))
        ),
        Morse("M", Morse("G", Morse("Z"), Morse("Q")), Morse("O")),
    ),
)
