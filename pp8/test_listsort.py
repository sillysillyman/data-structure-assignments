...
class TestListSort(unittest.TestCase):
    ...
    def test_split(self):
        ...
        self.compare(s, ["CS206", "is", "a"])
        self.compare(b, ["lot", "of", "fun", "a", "lot", "of", "fun", "is", "CS206"])
        c = b.split(b.last())
        self.assertTrue(c.is_empty())
        self.compare(b, ["lot", "of", "fun", "a", "lot", "of", "fun", "is", "CS206"])
        d = b.split(b.median())
        self.compare(b, ["lot", "of", "fun", "a", "lot"])
        self.compare(d, ["of", "fun", "is", "CS206"])
        e = d.split(d.first().prev)  # split on front sentinel
        self.assertTrue(d.is_empty())
        self.compare(e, ["of", "fun", "is", "CS206"])
    ...
    def test_merge(self):
        self.checkMerge(sol.DoublyLinkedList(), sol.DoublyLinkedList(), [])
        self.checkMerge(sol.DoublyLinkedList(), sol.DoublyLinkedList(1, 13), [1, 13])
        self.checkMerge(sol.DoublyLinkedList(2, 17), sol.DoublyLinkedList(), [2, 17])
        self.checkMerge(
            sol.DoublyLinkedList(1, 3, 13, 17, 25),
            sol.DoublyLinkedList(2, 5, 6, 8, 15, 29),
            [1, 2, 3, 5, 6, 8, 13, 15, 17, 25, 29],
        )
        self.checkMerge(
            sol.DoublyLinkedList(1, 5),
            sol.DoublyLinkedList(2, 6, 7, 8),
            [1, 2, 5, 6, 7, 8],
        )
        self.checkMerge(
            sol.DoublyLinkedList(1, 5, 7, 9),
